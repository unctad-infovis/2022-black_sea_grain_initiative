  ...
  plugins: [
    ...
    new CopyPlugin({
      patterns: [
        ...
        { from: 'assets/data/2022-black_sea_grain_initiative_table.csv', to: '../public/assets/data/2022-black_sea_grain_initiative_table.csv', noErrorOnMissing: true, globOptions: { dot: true, gitignore: true, ignore: ['**/.DS_Store'] }},
